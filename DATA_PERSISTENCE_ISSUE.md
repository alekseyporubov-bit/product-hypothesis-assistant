...
> ⚠️ **ОБНОВЛЕНО (2026-09-14):** ниже описан изначальный диагноз «данные только в
> памяти». На самом деле JSON-сохранение уже было реализовано, но данные всё равно
> терялись при редеплое из-за эфемерной файловой системы и запуска с 4 worker'ами.
> Полное исправление и инструкция — в [DATA_PERSISTENCE_FIX.md](./DATA_PERSISTENCE_FIX.md).
